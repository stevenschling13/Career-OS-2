...
import { Bell, Calendar, Briefcase, ArrowRight } from 'lucide-react';
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-gray-900">2 Events</h3>
            </div>
          </div>
          <div className="space-y-3">
             <div className="bg-gray-50 p-2 rounded text-sm">
                <span className="font-semibold block">Tech Screen - Google</span>
                <span className="text-gray-500 text-xs">Tomorrow, 10:00 AM PST</span>
             </div>
          </div>
        </div>
